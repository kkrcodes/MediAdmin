...
<!DOCTYPE html>
<html>
<title>MediAdmin - <?php $status=$_GET['filter'];
if($status==1)
{
   echo 'Minor';
}
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="filteredview.php?filter=1" class="w3-bar-item w3-button w3-padding <?php $status=$_GET['filter'];
    if($status==1)
       echo 'w3-blue';
    ?>">  Minor</a>
    <a href="filteredview.php?filter=2" class="w3-bar-item w3-button w3-padding <?php $status=$_GET['filter'];
    if($status==2)
       echo 'w3-blue';
    ?>">  Delayed</a>
    <a href="filteredview.php?filter=3" class="w3-bar-item w3-button w3-padding <?php $status=$_GET['filter'];
    if($status==3)
       echo 'w3-blue';
    ?>">  Immediate</a>
    <a href="filteredview.php?filter=4" class="w3-bar-item w3-button w3-padding <?php $status=$_GET['filter'];
    if($status==4)
       echo 'w3-blue';
    ?>">  Morgue</a>
