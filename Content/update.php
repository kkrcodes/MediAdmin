...
<!DOCTYPE html>
<html>
<title>MediAdmin - Update patient details</title>
<meta charset="UTF-8">
...
<?php
         $data = $db_camp->table('patients')->select(array('p_name','p_age','p_gender','p_bp','p_pulse','p_resp' ,'respirate' ,'perfusion', 'mental', 'salivate' , 'lacrimate','urinate', 'defecate', 'distress', 'emesis' , 'miosis' ,'status'))->find($_GET['id']);


            extract($data);$bptemporal=explode(",",$p_bp);
            ...
            echo'
                  <ul class="w3-ul w3-white">
                    <li class="w3-padding-16 w3-cell ">
                      <div class="w3-cell w3-left w3-margin-right">
                          <img src="pphoto/';
		echo $_GET['id'].'.jpg" class=" "  style="width:150px">';
            if($status==1)
            {
               echo '
            ...
            elseif ($status==4) {
               ...
               <div class="w3-container w3-grey">
                  <h4>Morgue</h4>
                      ...
                      <tr><td colspan="2"><h2>'.$p_name.'</h2><span class="w3-opacity"> #'.$_GET['id'].'</span></td></tr><tr><td colspan="2"> <span class="w3-opacity">'.$p_gender.'</span></td></tr>
...
?>
    ...
    <form action="updatedb.php" target="_blank"  method='post' enctype='multipart/form-data' style="width:500px;">
      <input type="hidden" name="idu" value="<?php echo $_GET['id']; ?>">
      <div class="w3-section w3-container">
        <label>Enter BP</label>
        <input class="w3-input w3-border" type="text" name="p_bpu" required>
      </div>
      <div class="w3-section w3-container">
        <label>Enter pulse</label>
        <input class="w3-input w3-border" type="text" name="p_pulseu" required>
      </div>
      <div class="w3-section w3-container">
        <label>Enter respiration</label>
        <input class="w3-input w3-border" type="text" name="p_respu" required>
      </div>

      <div class="w3-section w3-container">
         Respiration<br>
        <input class="" type='radio' name='respirateu' value="1" required>
         <label>Yes</label> &nbsp;&nbsp;&nbsp;
        <input class="" type='radio' name='respirateu' value="0" required>
         <label>No</label>
      </div>
      <div class="w3-section w3-container">
         Perfusion<br>
        <input class="" type='radio' name='perfusionu' value="1" required>
         <label>+2 Sec</label> &nbsp;&nbsp;&nbsp;
        <input class="" type='radio' name='perfusionu' value="0" required>
         <label>-2 Sec</label>
      </div>
      <div class="w3-section w3-container">
         Mental status<br>
        <input class="" type='radio' name='mentalu' value="1" required>
         <label>Can do</label> &nbsp;&nbsp;&nbsp;
        <input class="" type='radio' name='mentalu' value="0" required>
         <label>Can't do</label>
      </div>
<div class="w3-section w3-container">

<br>
      <input type='radio' name='statusu' value="1" required/> Minor&nbsp;&nbsp;&nbsp; <input type='radio' name='statusu' value="2" required/> Delayed &nbsp;&nbsp;&nbsp;<input type='radio' name='statusu' value="3" required/> Immediate&nbsp;&nbsp;&nbsp;
      <input type='radio' name='statusu' value='4' required /> Morgue
</div>


      <div class="w3-section w3-container">
      <button type="submit" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom">Update patient details</button>
   </div>
    </form>
</div>
</div>
